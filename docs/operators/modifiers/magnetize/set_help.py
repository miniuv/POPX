...
op_name.par.Initialpositionpop.help = "Reference to a POP containing initial positions for Simple solver mode."
...
op_name.par.Spindirx.help = "Spin rotation direction vector."
op_name.par.Contain.help = "Controls how strongly instances are kept within the magnetic field bounds."
op_name.par.Affectpos.help = "Enables position changes based on magnetic forces."
op_name.par.Moveweight.help = "Controls the intensity of position movement when Affect Position is enabled."
...
op_name.par.Outputforceattr.help = "Outputs a force attribute showing the magnetic force vector applied to each instance."
