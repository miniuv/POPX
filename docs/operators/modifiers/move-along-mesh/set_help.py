...
op_name.par.Openscalerampeditor.help = "Opens the internal scale ramp editor for creating custom scale curves over."
op_name.par.Resetscaleramp.help = "Resets the scale ramp to default values."
op_name.par.Customscaletop.help = "Reference to an external TOP for scale control."
...
op_name.par.Distribution.help = "Neighbor distribution method for relaxation."
