...
op_name.par.Microfacetrefraction.help = "Enables microfacet-based refraction model for rough transmissive materials."
...
op_name.par.Optixplugin.help = "File path to the NVIDIA OptiX denoiser plugin."
op_name.par.Optixreinitpulse.help = "Re-initializes the OptiX denoiser."
...
op_name.par.Dlssplugin.help = "File path to the NVIDIA DLSS denoiser plugin."
op_name.par.Dlssreinitpulse.help = "Re-initializes the DLSS denoiser."
op_name.par.Quality.help = "Quality preset for the DLSS denoiser."
