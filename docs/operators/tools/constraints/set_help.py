...
# Page: Geometry
op_name.par.Lockinput.help = "Lock the input geometry to prevent updates from upstream changes."
op_name.par.Reload.help = "Reload the input geometry and regenerate constraints."
op_name.par.Geogrouptype.help = "Specify whether to use point or primitive groups for geometry selection."
...
op_name.par.Mass.help = "How to calculate point mass."
...
op_name.par.Thickness.help = "How to calculate thickness."
...
op_name.par.Partitionmethod.help = "Method for dividing geometry into separate pieces."
...
op_name.par.Attrclass.help = "Attribute class when using From Attribute method."
...
op_name.par.Targetgrouptype.help = "Specify whether to use point or primitive groups for target geometry selection."
op_name.par.Targetgroup.help = "Name of the target geometry group to use. Leave empty for all."
op_name.par.Targetpath.help = "Path to the target geometry operator."
op_name.par.Visualizetarget.help = "Display the target geometry in the viewport for debugging."
...
op_name.par.Constrainttype.help = "Type of constraint to generate."
op_name.par.Visualizeconstraints.help = "Display constraint connections as lines in the viewport."
op_name.par.Constraintscolorr.help = "Color for visualizing constraints."
...
op_name.par.Pinpoints.help = "Point group name for pinning points to their animated positions."
op_name.par.Pintype.help = "Method for pinning points to their target positions."
op_name.par.Matchanimation.help = "Update pinned point positions to match input animation each frame."
op_name.par.Visualizepinned.help = "Display pinned points in the viewport for debugging."
