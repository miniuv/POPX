# TouchDesigner Python Script - Set Visualize-Frame Parameter Help Text

op_name = target

# Page: Visualize Frame
op_name.par.Bypass.help = "Pass through the first input to the output unchanged."
op_name.par.Lengthscale.help = "Controls the length of the orientation axis visualization lines."
...
print("Visualize-Frame parameter help text updated successfully!")
