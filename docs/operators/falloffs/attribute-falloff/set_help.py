...
op_name.par.Inputattr.help = "Name of the point attribute to read and convert into falloff values. Default is _PointI (point index)."

# Page: Falloff
op_name.par.Combineop.help = "Mathematical operation used to combine the attribute-based falloff with existing falloff values."
