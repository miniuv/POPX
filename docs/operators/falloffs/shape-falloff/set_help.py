...
op_name.par.Specpop.help = "Reference to a POP where each point is a specification defining a separate shape."
op_name.par.Shape.help = "Select the shape of the field."
op_name.par.Displayshape.help = "When enabled, renders a visual representation of the shape in the viewport for reference."
op_name.par.Displaycolorr.help = "Color used to display the shape when Display Shape is enabled."
op_name.par.Sizex.help = "The geometry 3D size."
op_name.par.Radx.help = "Radius of falloff shape."
...
op_name.par.Pointax.help = "Shape first point."
op_name.par.Pointbx.help = "Shape second point."
op_name.par.Exponent.help = "Sets the exponent on parabola falloff shapes."
op_name.par.Strengthx.help = "Sets the falloff shape strength."
...
op_name.par.Transitiontype.help = "Determines a transition function for weights."

# Page: Transform
op_name.par.Xord.help = "Order in which Scale, Rotate, and Translate operations are applied to the shape."
op_name.par.Rord.help = "Order in which rotations around the X, Y, and Z axes are applied."
op_name.par.Tx.help = "Translation offset applied to the shape in world space."
op_name.par.Rx.help = "Rotation angles in degrees around the X, Y, and Z axes."
op_name.par.Sx.help = "Scale factors applied to the shape along each axis."
