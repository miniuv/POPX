# TouchDesigner Python Script - Set Object-Falloff Parameter Help Text
...
op_name.par.Objectgeometry.help = "Reference to the POP geometry to use as the falloff object."
op_name.par.Displayobject.help = "When enabled, renders the object geometry in the viewport for visual reference."
op_name.par.Displaycolorr.help = "Display color for the object geometry when Display Object is enabled."
op_name.par.Areaofinfluence.help = "Determines how falloff values are calculated relative to the object geometry."
op_name.par.Threshold.help = "Distance threshold for surface intersection detection."
op_name.par.Xord.help = "Order of scale, rotate, and translate transformations for object space."
op_name.par.Rord.help = "Rotation axis order for object space transformation."
op_name.par.Tx.help = "Translation offset for object space."
op_name.par.Rx.help = "Rotation of object space in degrees."
op_name.par.Sx.help = "Scale factor for object space per axis."
op_name.par.Px.help = "Pivot point for object space transformations."
...
print("Object-Falloff parameter help text updated successfully!")
