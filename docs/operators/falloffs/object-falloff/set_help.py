...
op_name.par.Enablefeedback.help = "Enables feedback mode for accumulative falloff effects over time."
op_name.par.Initializefeedback.help = "Resets the feedback buffer to its initial state."
