...
op_name.par.Userestattr.help = "When enabled, evaluates noise using rest positions instead of current positions, preserving the noise pattern during deformations."
...
# Page: Transform
op_name.par.Xord.help = "Sets the overall transform order for the transformations."
op_name.par.Rord.help = "Sets the order of the rotations within the overall transform order."
op_name.par.Tx.help = "Translate the points through the noise space."
op_name.par.Rx.help = "Rotate the points around the corresponding X, Y and Z axes. Angles are given in degrees."
op_name.par.Sx.help = "These three fields scale the Source geometry in the three axes."
op_name.par.Px.help = "The pivot point for the transform rotates and scales."
