...
op_name.par.Spreadby.help = "Determines how the operator identifies neighboring points for spread propagation."
op_name.par.Distribution.help = "Controls how neighboring points are selected when using radius-based search."
op_name.par.Searchradius.help = "The maximum distance within which points are considered neighbors for spread propagation."
op_name.par.Maxconnections.help = "Limits the maximum number of neighboring connections each point can have."
op_name.par.Falloffwidth.help = "Controls how quickly the falloff strength diminishes as it spreads from the seed points."
op_name.par.Spreadamount.help = "Adds randomization to the spread pattern, creating more organic and varied falloff."
