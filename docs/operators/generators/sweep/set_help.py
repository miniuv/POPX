...
op_name.par.Twisttop.help = "Reference to an external TOP for twist control. When specified, overrides the internal ramp editor."
op_name.par.Twistpercurve.help = "When enabled with an external TOP, maps the texture to each curve individually for per-curve twist variation."
...
op_name.par.Scaletop.help = "Reference to an external Ramp TOP for scale control. When specified, overrides the internal ramp editor."
op_name.par.Scalepercurve.help = "When enabled with an external TOP, maps the texture to each curve individually for per-curve scale variation."
...
op_name.par.Colortop.help = "Reference to an external Ramp TOP for color control. When specified, overrides the internal ramp editor."
op_name.par.Colorpercurve.help = "When enabled with an external TOP, maps the texture to each curve individually for per-curve color variation."
...
op_name.par.Anglenormal.help = "For vertex normals, the threshold angle between faces above which the shared edge vertices don't share normals."
