...
op_name.par.Opentwistrampeditor.help = "Opens the twist ramp editor."
op_name.par.Resettwistramp.help = "Resets the twist ramp to default."
op_name.par.Customtwisttop.help = "Reference to an external TOP for twist control. When specified, overrides the internal ramp editor."
...
op_name.par.Openscalerampeditor.help = "Opens the scale ramp editor."
op_name.par.Resetscaleramp.help = "Resets the scale ramp to default."
op_name.par.Customscaletop.help = "Reference to an external Ramp TOP for scale control. When specified, overrides the internal ramp editor."
...
op_name.par.Opencolorrampeditor.help = "Opens the color ramp editor."
op_name.par.Resetcolorramp.help = "Resets the color ramp to default."
op_name.par.Customcolortop.help = "Reference to an external Ramp TOP for color control. When specified, overrides the internal ramp editor."
