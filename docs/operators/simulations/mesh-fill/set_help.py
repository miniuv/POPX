...
op_name.par.Continuoussim.help = "Enables continuous simulation mode where particles keep moving after initial fill completes."
op_name.par.Retention.help = "Amount of density retained between frames during continuous simulation."
op_name.par.Stopthreshold.help = "Density threshold below which the simulation stops filling."
